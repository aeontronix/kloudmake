...
public class AntLRUtils {
    ...
    public static Parameters toParams(List<KloudmakeLangParser.ParameterContext> paramListContext) throws InvalidScriptException {
        Parameters params = new Parameters();
        if (paramListContext != null) {
            for (KloudmakeLangParser.ParameterContext paramContext : paramListContext) {
                Parameter parameter = Parameter.create(paramContext.staticOrDynamicValue());
                KloudmakeLangParser.AnyIdContext idVal = paramContext.anyId();
                if (idVal != null) {
    ...
    public static String toString(KloudmakeLangParser.StaticValueContext ctx) {
        if (ctx == null) {
            return null;
        } else if (ctx.nb != null) {
    ...
    public static String toString(KloudmakeLangParser.StringContext ctx) {
        if (ctx == null) {
            return null;
