 ...
 * <li>{@link com.kloudtek.systyrant.context.Resource}: The resource corresponding to the java class will be injected</li>
 * <li>In any other case, it will attempt to inject a service of the specified class type using
 * {@link com.kloudtek.systyrant.ServiceManager#getService(Class)}</li>
 * </ul>
