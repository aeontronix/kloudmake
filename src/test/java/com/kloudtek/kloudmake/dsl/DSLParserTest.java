...
/**
 * Those tests check {@link com.kloudtek.kloudmake.dsl.DSLScript} objects produced by DSL code snippets.
 */
public class DSLParserTest extends AbstractContextTest {
    ...
    public void testCreateAutoLoadExplicitelyNamedElement() throws Throwable {
        ctx.runScript("com.kloudtek.kloudmake.dsl.autoload { \"myid\": attr1 = 'val1' }");
        assertTrue(ctx.execute());
        assertResources("com.kloudtek.kloudmake.dsl.autoload:myid", "test.test:myid.foo");
    }

    @Test
    public void testCreateAutoLoadImportedElement() throws Throwable {
        ctx.runScript("import foo.bar; import com.kloudtek.kloudmake.dsl; autoload { \"myid\": attr1 = 'val1' }");
        assertTrue(ctx.execute());
        assertResources("com.kloudtek.kloudmake.dsl.autoload:myid", "test.test:myid.foo");
        assertResourceParent("com.kloudtek.kloudmake.dsl.autoload:myid", null);
    }
