...
import com.aeontronix.aeonbuild.dsl.statement.CreateResourceStatement;
import com.aeontronix.aeonbuild.dsl.statement.InvokeMethodStatement;
...
public class RawDSLParserTest {
    private final ArrayList<RawDSLParserTester> testers = new ArrayList<>();
