...
import com.aeontronix.aeonbuild.AbstractTask;
...
public class DSLParserTest extends AbstractContextTest {
    ...
    public void testCreateAutoLoadExplicitelyNamedElement() throws Throwable {
        ctx.runScript("com.aeontronix.aeonbuild.dsl.autoload { \"myid\": attr1 = 'val1' }");
        assertTrue(ctx.execute());
        assertResources("com.aeontronix.aeonbuild.dsl.autoload:myid", "test.test:myid.foo");
    }

    @Test
    public void testCreateAutoLoadImportedElement() throws Throwable {
        ctx.runScript("import foo.bar; import com.aeontronix.aeonbuild.dsl; autoload { \"myid\": attr1 = 'val1' }");
        assertTrue(ctx.execute());
        assertResources("com.aeontronix.aeonbuild.dsl.autoload:myid", "test.test:myid.foo");
        assertResourceParent("com.aeontronix.aeonbuild.dsl.autoload:myid", null);
    }
