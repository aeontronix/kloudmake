...
import com.aeontronix.aeonbuild.util.VariableMap;
...
public class ResourceImpl implements Resource {
    ...
    private transient BuildContextImpl context;
    ...
    public ResourceImpl(BuildContextImpl context, ResourceDefinition definition, String id, String uid, Resource parent) {
    ...
    /**
     * Add a notification handler to this resource. This can only be done before the {@link com.aeontronix.aeonbuild.Stage#EXECUTE} stage.
     *
    ...
    @Override
    public BuildContextImpl context() {
        return context;
    }
