...
import com.aeontronix.aeonbuild.java.JavaResourceDefinitionFactory;
...
public class ResourceManagerImpl implements ResourceManager {
    ...
    public ResourceManagerImpl(BuildContextImpl context) {
    ...
    @Override
    public void setContext(BuildContextImpl context) {
        this.context = context;
    }
