...
import com.aeontronix.aeonbuild.annotation.Alternative;
...
public class JavaTask extends AbstractTask {
    ...
    private Object invoke(BuildContextImpl context, Resource resource, Method method) throws KMRuntimeException {
    ...
    protected void injectAndValidate(Resource resource, Object javaImpl, BuildContextImpl ctx) throws FieldInjectionException, ResourceValidationException {
