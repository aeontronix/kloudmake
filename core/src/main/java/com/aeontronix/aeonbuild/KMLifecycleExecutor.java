...
import com.aeontronix.aeonbuild.exception.MultipleUniqueResourcesFoundException;
import com.aeontronix.aeonbuild.host.Host;
import com.aeontronix.aeonbuild.util.SetHashMap;
...
public class KMLifecycleExecutor {
    public boolean execute() throws KMRuntimeException {
        ...
        try {
            ...
            logger.info("AeonBuild context execution started");
            ...
            if (successful) {
                logger.info("AeonBuild context execution completed");
            } else {
                logger.warn("AeonBuild context execution completed with some errors");
            }
            return successful;
        } finally {
    ...
    public KMLifecycleExecutor(BuildContextImpl context) {
