...
package com.aeontronix.aeonbuild.service.credstore;
...
import com.aeontronix.aeonbuild.util.AESHelper;
...
public class CredStore implements AutoCloseable {
    ...
    public static CredStore get(BuildContextImpl ctx) throws InvalidServiceException {
