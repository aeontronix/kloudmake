...
public class FileDefinition {
    ...
    public FileDefinition() {
        sourceUrl = BuildContextImpl.get().getSourceUrl();
    }
    ...
    /**
     * Return the Hex encoded SHA1 checksum hash of the file.
     *
     ...
     * cannot be downloaded automatically by AeonBuild (for example due to license distribution restrictions).
     *
