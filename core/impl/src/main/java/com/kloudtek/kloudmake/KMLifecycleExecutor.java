...
public class KMLifecycleExecutor {
    public boolean execute() throws KMRuntimeException {
        ...
        try {
            ...
            logger.info("Kloudmake context execution started");
            ...
            if (successful) {
                logger.info("Kloudmake context execution completed");
            } else {
                logger.warn("Kloudmake context execution completed with some errors");
            }
            return successful;
        } finally {
