...
public class DSLQueryLangTests extends AbstractContextTest {
    ...
    public static void main(String[] args) {
        KloudmakeLangParser parser = new KloudmakeLangParser(new CommonTokenStream(new KloudmakeLangLexer(new ANTLRInputStream("parent1.as.someid"))));
        KloudmakeLangParser.QueryContext queryUidMatchContext = parser.query();
